  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: ListView(
        children: [
          Obx(()=>ProfileCard(
              name: editProfileController.userInfo['fullName'] ?? 'Đang cập nhập',
              email: editProfileController.getUserEmail(),
              imageSrc: editProfileController.userInfo['avatarUrl']==''
                  ? 'assets/images/user.jpg'
                  : editProfileController.userInfo['avatarUrl'] ?? 'assets/images/user.jpg',
              // proLableText: "Sliver",
